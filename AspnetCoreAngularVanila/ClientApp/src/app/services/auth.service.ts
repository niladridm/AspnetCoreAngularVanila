...
export class AuthService {
  ...
  private configureOauthService(rememberMe?: boolean) {
    ...
    this.oauthService.clientId = 'AspnetCoreAngularVanila_spa';
    this.oauthService.scope = 'openid email phone profile offline_access roles AspnetCoreAngularVanila_api';
