...
using AspnetCoreAngularVanila.Authorization;
using AspnetCoreAngularVanila.Helpers;
using AspnetCoreAngularVanila.ViewModels;
using Swashbuckle.AspNetCore.Swagger;
using System;
using System.Collections.Generic;
using AppPermissions = DAL.Core.ApplicationPermissions;

namespace AspnetCoreAngularVanila
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("AspnetCoreAngularVanila")));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - AspnetCoreAngularVanila";
